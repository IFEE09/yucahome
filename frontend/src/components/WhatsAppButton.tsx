...
export default function WhatsAppButton() {
    ...
    return (
        <button
            onClick={handleClick}
            className="fixed bottom-6 right-6 z-50 bg-primary text-white w-16 h-16 rounded-full shadow-2xl hover:scale-[1.16] transition-all duration-300 flex items-center justify-center"
