            ...
            <div className="bg-white w-full md:max-w-2xl rounded-t-[2rem] md:rounded-[2rem] shadow-2xl h-[92vh] md:h-auto md:max-h-[90vh] overflow-y-auto animate-slide-up md:animate-fade-in user-select-none">
                <div className="p-5 md:p-8 pb-20 md:pb-8"> {/* Padding extra bottom en móvil para scroll */}
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
                        ...
                        {/* Galería de Fotos (Adicional) - Solo visual por ahora se envía con el form */}
                        <div>
                            <label className="block text-[10px] md:text-xs uppercase font-bold text-textMuted mb-2 px-1">
                                Fotos de la Propiedad (Galería)
                            </label>
                            <div className="relative border-2 border-dashed border-gray-200 bg-gray-50 hover:border-primary/50 rounded-2xl p-6 transition-colors text-center group active:scale-[0.99] touch-manipulation">
                                <input
                                    type="file"
                                    name="gallery"
                                    multiple
                                ...
                                />
                                <div className="flex flex-col items-center pointer-events-none">
                                    <div className="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center mb-2 text-textMuted group-hover:text-primary transition-colors">
